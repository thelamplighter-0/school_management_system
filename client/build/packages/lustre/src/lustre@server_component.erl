...
-spec element(
    list(lustre@vdom@vattr:attribute(USQ)),
    list(lustre@vdom@vnode:element(USQ))
) -> lustre@vdom@vnode:element(USQ).
...
-spec include(lustre@vdom@vattr:attribute(UTC), list(binary())) -> lustre@vdom@vattr:attribute(UTC).
...
-spec subject(lustre:runtime(UTG)) -> gleam@erlang@process:subject(lustre@runtime@server@runtime:message(UTG)).
subject(Runtime) ->
...
-spec register_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(UTO))
) -> lustre@runtime@server@runtime:message(UTO).
...
-spec deregister_subject(
    gleam@erlang@process:subject(lustre@runtime@transport:client_message(UTS))
) -> lustre@runtime@server@runtime:message(UTS).
...
-spec register_callback(
    fun((lustre@runtime@transport:client_message(UTW)) -> nil)
) -> lustre@runtime@server@runtime:message(UTW).
...
-spec deregister_callback(
    fun((lustre@runtime@transport:client_message(UTZ)) -> nil)
) -> lustre@runtime@server@runtime:message(UTZ).
...
-spec select(
    fun((fun((UUE) -> nil), gleam@erlang@process:subject(any())) -> gleam@erlang@process:selector(UUE))
) -> lustre@effect:effect(UUE).
select(Sel) ->
